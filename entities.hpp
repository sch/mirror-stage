...
/* I use several of the latter variables in the Entity struct for
 * different things depending on the type.  It's not great, and has
 * resulted in some odd encodings.
 */
struct Entity {
    Etype   type;
