...
enum TitleSubOption {
    ts_main,
    ts_newgameselect,
    ts_newgamechapterselect,
    ts_newcustomgameselect,
    ts_newcustomgamechapterselect,
    ts_editgameselect,
    ts_editentername,
    ts_editchapterselect,
    ts_nofiles,
    ts_editnofiles
};
...
void RenderRoom(int room_t, int room_f, int edge_t, int edge_f,
                bool parity, bool globparity, GLfloat depth,
                GLfloat realdepth, GLfloat outers);
void buildOutlines();
void buildLists();
bool init_GL();
bool init();
